...
class IngredienceTaker:
	...
	def remove_nonneeded_words(self):
		...
		units = ["half", "halves","double","each","milliliter", "milliliters","gram","handful","fl","gallon","few","cubes","four","liter","six","slice","pieces","l","lbs","s","us", "use","t","tbs","ten","xxinch","xinch","three","two","percent","ml", "grams","oz", "lb", "kg", "qt", "pound", "pounds", "g", "ounces", "aj", "one", "ounce", "bag", "bags", "inch", "single", "ml"]
